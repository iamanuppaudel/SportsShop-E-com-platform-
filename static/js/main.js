...
$(document).ready(function(){
  ...
  //------- Active Nice Select --------//
    ...
    $(".active-banner-slider").owlCarousel({
        ...
        loop:true,
        nav:true,
        navText:['<i class="fa fa-chevron-left" style="color:red;"></i>','<i class="fa fa-chevron-right" style="color:red;"></i>'],
        dots:false
    });
...
var countDownDate = new Date("Feb 18, 2022 22:44:00").getTime();
...
var x = setInterval(function() {
  ...
  document.getElementById("countermsg").innerHTML = "New offers to arrive soon. Stay updated for more offers.";
